...
<link rel=stylesheet href="css/styles.css?v={CSS_VERSION}" type="text/css">
<script language="javascript" type="text/javascript" src="script.js?v={CSS_VERSION}"></script>
...
<link rel="stylesheet" type="text/css" href="css/responsive.css?v={CSS_VERSION}" />
...
<!--==============================================================================================-->
<a id="simple-menu" href="#sidr"><img src="images/menu.png" width="50"></a>
